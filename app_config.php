<?php
	...
	//default settings
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "73c4b230-a210-4971-b147-be2a6fc68e47";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "call_center";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "agents_limit";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "numeric";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "5";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Limits quantity of agents in queue when using «Ring All» strategy";
